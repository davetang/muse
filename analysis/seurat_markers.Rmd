...
purrr::map_dbl(row.names(markers), run_presto_wilcox) -> presto_p_values

plot(markers$p_val, presto_p_values, pch = 16)
abline(a = 0, b = 1, lty = 2, col = 2)
```
...
all(p.adjust(manual_p_values, method = "bonferroni") == markers$p_val_adj)
```
