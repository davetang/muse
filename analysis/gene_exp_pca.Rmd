...
```{r plot_PCA, fig.width=6, fig.height=6}
...
```{r plot_PCA_copied, fig.width=6, fig.height=6}
...
Note that the order is the same, because `plotPCA()` already sorted the genes by their variance!
