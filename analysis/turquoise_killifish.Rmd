...
Download GAF file `*_gene_ontology.gaf.gz`, which contains Gene Ontology (GO) annotation of the annotated genes in GO Annotation File [GAF format](https://geneontology.org/docs/go-annotation-file-gaf-format-2.1/).
