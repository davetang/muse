...
cat(sprintf("  theta_A = %.4f\n", result$theta_A))
cat(sprintf("  theta_B = %.4f\n", result$theta_B))
```
...
```{r coins_convergence, fig.width=8, fig.height=5, fig.cap="Convergence of coin bias estimates across EM iterations."}
